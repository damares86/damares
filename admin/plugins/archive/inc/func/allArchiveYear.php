        ...
        <tbody>
          ...
          ?>
            <tr>
              <td><?= $row['year'] ?></td>
              <td>
                <a href="index.php?p=editArchiveYear&idToMod=<?= $row['id'] ?>" class="btn icon btn-warning shadow edit-link" data-base-url="index.php?p=editArchiveYear&idToMod=<?= $row['id'] ?>"><i class="bi bi-pencil-square"></i></a>
                &nbsp; &nbsp;
                  ...
                  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <span class="d-none d-sm-block"><a href="core/mngArchive.php?idYearToDel=<?= $row['id'] ?>" class="btn btn-danger ml-1"><?= $common_modal_confirm ?></a></span>
                      </div>
                    </div>
                  </div>
                </div>
