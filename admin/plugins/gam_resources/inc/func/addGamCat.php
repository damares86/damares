    ...
    <div class="row">
        <div class="col-md-8 col-12">
            <div class="card">
                ...
                <h4 class="card-title"><?=$gam_cat_add_title?></h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-body">
                        <div class="row">
                        <div class="col-md-3">
                            <label><?=$gam_cat_add_name?><span class="text-danger">*</span></label>
                        </div>
                        <div class="col-md-9">
                        ...
                        <input type="hidden" name="origin" value="addGamCat">
