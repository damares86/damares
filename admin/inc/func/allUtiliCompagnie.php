      ...
      <div class="row border-top border-bottom py-3 my-3">
        <div class="col">
          ...
          <div class="row">
            ...
            <div class="col-4">
              <form class="form form-horizontal p-2 mb-5 border-bottom" action="core/mngCompagnie.php" method="POST"  enctype="multipart/form-data" data-parsley-validate>
              <div class="form-body">
                ...
                <div class="row">
                  ...
                  <input type="hidden" name="origin" value="allUtiliCompagnie">
      ...
      <table class="table" id="table2">
        ...
        while($row = $compagnie->fetch(PDO::FETCH_ASSOC))
        {
          ...
          while($row1 = $stmt1->fetch(PDO::FETCH_ASSOC))
          {
            ...
            $provv = $provv_calc_arr[$row['provv_calcolate_su']];
            // calcollo consulenza
