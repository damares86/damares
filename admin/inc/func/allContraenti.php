...
<section class="section">
  <div class="card">
    <div class="card-header">Tutti i contraenti &nbsp; &nbsp; &nbsp; 
    <a href="index.php?p=addContraente" class="btn icon icon-left btn-success"
    ><i data-feather="plus-circle"></i> Aggiungi un contraente</a>
    </div>
    <div class="card-body">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    >
                                      ...
                                      <span class="d-none d-sm-block"
                                        ><a href="core/mngContraenti.php?idToDel=<?=$row['id']?>" class="btn btn-danger ml-1">
