    ...
    <div class="modal-dialog">
      <form id="addEventForm" class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="eventColor" class="form-label">Colore (opzionale)</label>
            <input type="color" class="form-control form-control-color" id="eventColor" name="color" value="#008db1">
          </div>
        </div>
        <div class="modal-footer">
