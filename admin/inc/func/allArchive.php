    ...
    <div class="card-body">
      <table class="table" id="table">
        ...
        <tbody>
          ...
          <?php
          while ($row = $allarchive->fetch(PDO::FETCH_ASSOC)) {
            extract($row);
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                $archive->id = $row['archive_year_id'];

                $stmt1 = $archive->showAllWhere('id', ['id']);
                ...
                echo $month_str . $row1['year'];
                ?>

              </td>

              <td>
                <a href="../uploads/archive/<?= $row['file_name'] ?>" target="_blank"><?= $common_link ?></a>
              </td>
              <td>
                <a href="index.php?p=editArchive&idToMod=<?= $row['id'] ?>" class="btn icon btn-warning shadow edit-link" data-base-url="index.php?p=editArchive&idToMod=<?= $row['id'] ?>"><i class="bi bi-pencil-square"></i></a>
                &nbsp; &nbsp;
                  ...
                  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <span class="d-none d-sm-block"><a href="core/mngArchive.php?idToDel=<?= $row['id'] ?>" class="btn btn-danger ml-1"><?= $common_modal_confirm ?></a></span>
                      </div>
                    </div>
                  </div>
                </div>
