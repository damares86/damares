<div class="page-title">
  <div class="row">
    <div class="col-12 col-md-6 order-md-1 order-last">
      <h3>Aggiungi una categoria di file</h3>
    </div>
      ...
      >
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">
            Aggiungi una categoria di file
          </li>
        </ol>
      </nav>
    </div>
    ...
    <div class="row">
        <div class="col-md-8 col-12">
            <div class="card">
                ...
                <h4 class="card-title">Aggiungi una categoria di file di prodotto</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-body">
                        ...
                        <input type="hidden" name="origin" value="addXSProductCat">
