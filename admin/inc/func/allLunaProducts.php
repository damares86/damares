...
<section class="section">
  <div class="card shadow">
    <div class="card-header">All Luna products &nbsp; &nbsp; &nbsp;
          ...
          ?>
            <tr <?= $class ?>>
              ...
              <td>
                ...
                &nbsp; &nbsp;
                <a href="#" class="btn icon btn-danger shadow" data-bs-toggle="modal" data-bs-target="#danger<?= $row['id'] ?>">Delete <i class="bi bi-trash"></i>
                </a>
                    ...
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                        <h5 class="modal-title white" id="myModalLabel120">
                          Creating a new version of the product documentation
                        </h5>
