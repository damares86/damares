                        ...
                        <form class="form form-horizontal" action="core/mngSubscriber.php" method="POST" enctype="multipart/form-data" data-parsley-validate>
                            <div class="form-body">
                                <div class="row">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="form-check mandatory">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="Name" id="first-name-icon" name="name" data-parsley-required="true" />
                                    ...
                                    <input type="hidden" name="origin" value="addSubscriber">
