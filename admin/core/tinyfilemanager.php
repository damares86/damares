...
$CONFIG = '{"error_reporting":false,"show_hidden":false,"hide_Cols":false,"theme":"light"}';
...
$root_path = $_SERVER['DOCUMENT_ROOT'] . '/damares/uploads';
            ...
            ?>
                <tr>
                    ...
                    <td class="inline-actions"><?php if (!FM_READONLY): ?>
                        ...
                        <?php endif; ?>
                        <a title="<?php echo lng('DirectLink') ?>" href="<?php echo '../../uploads/img/' . $f . '/' ?>" target="_blank"><i class="fa fa-link" aria-hidden="true"></i></a>
...
function fm_get_translations()
{
    $tr = [];
    try {
        $content = @file_get_contents('../locale/fm_translation.json');
        if ($content !== false) {
            $lng = json_decode($content, true);
            global $lang_list;
            foreach ($lng["language"] as $value) {
                $code = $value["code"];
...
?>
    <!DOCTYPE html>
    <html lang="it" data-bs-theme="<?php echo (FM_THEME == "dark") ? 'dark' : 'light' ?>">
