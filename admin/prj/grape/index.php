...
<script>
    ...
    // Send the formatted HTML as a parameter to the PHP script
    xhr.send('formattedHtml=' + encodeURIComponent(formattedHtml));
...
// $formattedHtml = preg_replace('~<(?:!DOCTYPE|/?(?:html|body))[^>]*>\s*~i', '', $formattedHtml);

// // Output the formatted HTML
// echo $formattedHtml;

// // Save the formatted HTML to a file
// file_put_contents('formatted.html', $formattedHtml);
...
// // Use tidy to format and clean up the HTML
// $tidyConfig = array(
//     'indent' => true,
//     'output-xhtml' => true,
//     'wrap' => 200
...
// $tidy = new tidy();
// $tidy->parseString($dom->saveHTML(), $tidyConfig, 'utf8');
// $tidy->cleanRepair();

// // Get the formatted HTML using the body method
// $formattedHtml = $tidy->value ;

// // Save the formatted HTML to index.php
// file_put_contents('test.php', $formattedHtml);

// echo 'HTML has been formatted and saved to index.php.';
?>