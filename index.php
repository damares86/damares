						...
						<div class="row pt-5">
							<div class="col-lg-5 col-md-8">
								<div class="slider-title">
									...
									<a href="demo-seo-about.html" class="button button-rounded button-large text-transform-none ls-0">Get Started</a>
									...
									<div id="pricing-switch" class="pricing row align-items-end g-0 col-mb-50 mb-4">
											...
											<div class="pricing-box">
												...
												<div class="pricing-features border-0 bg-transparent">
													<ul>
														...
														<li class="pts-switch-content-left text-black-50"><i class="bi-dash-circle me-2"></i><del style="opacity: .5"><strong>1</strong> Free Optimization</del></li>
														<li class="pts-switch-content-right"><i class="fa-solid fa-check-circle color me-2"></i><strong>1</strong> Free Optimization</li>
												...
												<div class="pricing-action">
													<div class="pts-switch-content-left"><a href="#" class="button button-large button-rounded w-100 text-capitalize m-0 ls-0">Get Started</a></div>
													<div class="pts-switch-content-right"><a href="#" class="button button-large button-rounded w-100 text-capitalize m-0 ls-0">Get Started</a></div>
												</div>
											</div>
										...
										<div class="col-md-6">
											...
											<div class="pricing-box">
												...
												<div class="pricing-action">
													<div class="pts-switch-content-left"><a href="#" class="button button-rounded button-large button-light text-dark bg-white border w-100 text-transform-none m-0 ls-0">Get Started</a></div>
													<div class="pts-switch-content-right"><a href="#" class="button button-rounded button-large button-light text-dark bg-white border w-100 text-transform-none m-0 ls-0">Get Started</a></div>
												</div>
											</div>
				...
				<div class="section m-0" style="background: url('demos/seo/images/sections/5.jpg') no-repeat center center; background-size: cover;padding: 80px 0;">
					<div class="container">
						...
						<div class="text-center">
							<a href="demo-seo-about.html" class="button button-large button-rounded text-capitalize ms-0 mt-5 ls-0">View All Works</a>
						</div>
				...
				<div class="section mt-5 footer-stick promo-section bg-transparent" style="padding: 100px 0; overflow: visible">
					<div class="container">
						<div class="heading-block border-bottom-0 text-center">
							...
							<a href="demo-seo-contact.html" class="button button-large button-rounded text-transform-none ms-0 ls-0 mt-4">Contact Us Now</a>
						</div>
					</div>
				</div>
			</div>
